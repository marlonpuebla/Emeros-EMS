...
async function initDb() {
  ...
  const migrations = [
    ...
    // 004 — incident report compliance fields (Joint Commission, FL §395.0197, OSHA 300, HIPAA)
    'ALTER TABLE incident_reports ADD COLUMN severity TEXT',
    'ALTER TABLE incident_reports ADD COLUMN patient_involved INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN patient_identifier TEXT',
    'ALTER TABLE incident_reports ADD COLUMN injury_type TEXT',
    'ALTER TABLE incident_reports ADD COLUMN body_part TEXT',
    'ALTER TABLE incident_reports ADD COLUMN treatment TEXT',
    'ALTER TABLE incident_reports ADD COLUMN sentinel_event INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN fl_ahca_reportable INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN fl_ahca_reported_date TEXT',
    'ALTER TABLE incident_reports ADD COLUMN hipaa_breach INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN hipaa_breach_date TEXT',
    'ALTER TABLE incident_reports ADD COLUMN contributing_factors TEXT',
    'ALTER TABLE incident_reports ADD COLUMN witnesses TEXT',
    'ALTER TABLE incident_reports ADD COLUMN equipment_involved TEXT',
    'ALTER TABLE incident_reports ADD COLUMN medication_name TEXT',
    'ALTER TABLE incident_reports ADD COLUMN medication_dose TEXT',
    'ALTER TABLE incident_reports ADD COLUMN medication_route TEXT',
    'ALTER TABLE incident_reports ADD COLUMN follow_up_required INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN follow_up_date TEXT',
    'ALTER TABLE incident_reports ADD COLUMN follow_up_by TEXT',
    'ALTER TABLE incident_reports ADD COLUMN risk_manager_notified INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN risk_manager_notified_at TEXT',
    'ALTER TABLE incident_reports ADD COLUMN physician_notified INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN physician_notified_at TEXT',
    'ALTER TABLE incident_reports ADD COLUMN family_notified INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN family_notified_at TEXT',
    'ALTER TABLE incident_reports ADD COLUMN admin_notified INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN admin_notified_at TEXT',
    'ALTER TABLE incident_reports ADD COLUMN law_enforcement_notified INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN law_enforcement_notified_at TEXT',
    'ALTER TABLE incident_reports ADD COLUMN dcf_reported INTEGER DEFAULT 0',
    'ALTER TABLE incident_reports ADD COLUMN dcf_reported_date TEXT',
